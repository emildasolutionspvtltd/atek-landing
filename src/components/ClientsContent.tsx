          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {industries.map((industry, index) => (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br from-${industry.color}-500/20 to-${industry.color}-600/20 rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10`}></div>
                
                <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-${industry.color}-500 to-${industry.color}-600 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-medium group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 mb-6`}>
                  {industry.icon}
                </div>
